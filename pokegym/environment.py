...
class Base:
    def __init__(
        ...
        **kwargs,
        ...
        self.env_id = f'{str(uuid.uuid4())[:4]}'
        self.reset_count = 0               
        self.explore_hidden_obj_weight = 1
        R, C = self.screen.raw_screen_buffer_dims()
        self.obs_size = (R // 2, C // 2, 3)
...
class Environment(Base):
    def __init__(self,rom_path="pokemon_red.gb",state_path=None,headless=True,save_video=False,quiet=False,verbose=False,**kwargs,):
        ...
        self.reset_counter = 763-(763-self.reset_count)
    ...
    def step(self, action, fast_video=True):
        ...
        exploration_reward = ram_map.explore(self)
        ...
        ram_map.update_pokedex(self)
        ram_map.update_moves_obtained(self)
