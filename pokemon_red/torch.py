...
class Policy(nn.Module):
    def __init__(self, env, *args, framestack=4, flat_size=64*5*6+11, input_size=512, hidden_size=512, output_size=512, channels_last=True, downsample=1, **kwargs): #64*6*6+90
        super().__init__()
